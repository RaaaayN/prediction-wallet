...
import { LayoutDashboard, Terminal, Briefcase, ShieldAlert, BarChart3, History, BookOpen, Activity, Zap, TrendingUp, Layers, Fingerprint, ClipboardList } from 'lucide-react';
